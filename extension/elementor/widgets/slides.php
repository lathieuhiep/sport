...
class sport_widget_slides extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Slides Theme', 'sport' );
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->start_controls_tab( 'background', [ 'label' => esc_html__( 'Background', 'sport' ) ] );

        $repeater->add_control(
            'slides_image',
            [
                'label'     =>  esc_html__( 'Image', 'sport' ),
        ...
        $repeater->add_control(
            'background_size',
            [
                'label' => _x( 'Size', 'Background Control', 'sport' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'cover',
                'options' => [
                    'cover' => _x( 'Cover', 'Background Control', 'sport' ),
                    'contain' => _x( 'Contain', 'Background Control', 'sport' ),
                    'auto' => _x( 'Auto', 'Background Control', 'sport' ),
                ],
                'selectors' => [
        ...
        $repeater->add_control(
            'background_overlay',
            [
                'label' => esc_html__( 'Background Overlay', 'sport' ),
        ...
        $repeater->start_controls_tab( 'content', [ 'label' => esc_html__( 'Content', 'sport' ) ] );

        $repeater->add_control(
            'heading',
            [
                'label' => esc_html__( 'Title & Description', 'sport' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Slide Heading', 'sport' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'button_text',
            [
                'label' => esc_html__( 'Button Text', 'sport' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Click Here', 'sport' ),
            ]
        );
        ...
        $repeater->start_controls_tab( 'style', [ 'label' => esc_html__( 'Style', 'sport' ) ] );

        $repeater->add_control(
            'custom_style',
            [
                'label' => esc_html__( 'Custom', 'sport' ),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'Set custom style that will only affect this specific slide.', 'sport' ),
            ]
        );
        ...
        $repeater->add_control(
            'horizontal_position',
            [
                'label' => esc_html__( 'Horizontal Position', 'sport' ),
        ...
        $repeater->add_control(
            'vertical_position',
            [
                'label' => esc_html__( 'Vertical Position', 'sport' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'top' => [
                        'title' => esc_html__( 'Top', 'sport' ),
                        'icon' => 'eicon-v-align-top',
                    ],
                    'middle' => [
                        'title' => esc_html__( 'Middle', 'sport' ),
                        'icon' => 'eicon-v-align-middle',
                    ],
                    'bottom' => [
                        'title' => esc_html__( 'Bottom', 'sport' ),
        ...
        $repeater->add_control(
            'text_align',
            [
                'label' => esc_html__( 'Text Align', 'sport' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   =>  [
                    [
                        'heading' => esc_html__( 'Slider 1 Heading', 'sport' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'sport' ),
                        'button_text' => esc_html__( 'Click Here', 'sport' ),
                        'link' => '#'
                    ],
                    [
                        'heading' => esc_html__( 'Slider 2 Heading', 'sport' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'sport' ),
                        'button_text' => esc_html__( 'Click Here', 'sport' ),
                        'link' => '#'
                    ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Slider Options', 'sport' ),
        ...
        $this->add_responsive_control(
            'content_max_width',
            [
                'label' => esc_html__( 'Content Width', 'sport' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'heading_spacing',
            [
                'label' => esc_html__( 'Spacing', 'sport' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'heading_color',
            [
                'label' => esc_html__( 'Text Color', 'sport' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_border_width',
            [
                'label' => esc_html__( 'Border Width', 'sport' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Border Radius', 'sport' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->start_controls_tab( 'normal', [ 'label' => esc_html__( 'Normal', 'sport' ) ] );
        ...
        $this->add_control(
            'button_border_color',
            [
                'label' => esc_html__( 'Border Color', 'sport' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab( 'hover', [ 'label' => esc_html__( 'Hover', 'sport' ) ] );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Navigation', 'sport' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->add_control(
            'arrows_size',
            [
                'label' => esc_html__( 'Arrows Size', 'sport' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_control(
            'arrows_color',
            [
                'label' => esc_html__( 'Arrows Color', 'sport' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'arrows_color_hover',
            [
                'label' => esc_html__( 'Arrows Color Hover', 'sport' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'dots_size',
            [
                'label' => esc_html__( 'Dots Size', 'sport' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 5,
        ...
        $this->add_control(
            'dots_color',
            [
                'label' => esc_html__( 'Dots Color', 'sport' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'dots_color_hover',
            [
                'label' => esc_html__( 'Dots Color Hover', 'sport' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    ?>
        ...
        <div class="element-slides owl-carousel owl-theme" data-settings='<?php echo esc_attr( wp_json_encode( $sport_slider_settings ) ); ?>'>

            <?php

            foreach ( $settings['slides_list'] as $item ) :
                $sport_slides_link         =   $item['link'];
...
Plugin::instance()->widgets_manager->register_widget_type( new sport_widget_slides );