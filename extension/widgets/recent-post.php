...
class sport_recent_post_widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        $widget_ops = array(
            'classname'     =>  'sport_recent_post_widget',
            'description'   =>  esc_html__( 'A widget show post', 'sport' ),
        );

        parent::__construct( 'sport_recent_post_widget', 'Sport Theme: Recent Post', $widget_ops );
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>">
                <?php esc_attr_e( 'Select Categories:', 'sport' ); ?>
            </label>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'select_cat' ) ) . '[]'; ?>" class="widefat" size="10" multiple>
                ...
                <option value="0" <?php echo ( in_array( 0, $select_cat ) ? 'selected="selected"' : '' ); ?>>
                    <?php esc_html_e( 'All Category', 'sport' ); ?>
                </option>
        ...
        <p>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'order' ) ); ?>" name="<?php echo $this->get_field_name('order') ?>" class="widefat">
                <option value="ASC" <?php echo ( $order == 'ASC' ) ? 'selected' : ''; ?>>
                    <?php esc_html_e( 'ASC', 'sport' ); ?>
                </option>

                <option value="DESC" <?php echo ( $order == 'DESC' ) ? 'selected' : ''; ?>>
                    <?php esc_html_e( 'DESC', 'sport' ); ?>
                </option>
            </select>
        </p>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>">
                <?php esc_html_e( 'Number of posts to show:', 'sport' ); ?>
            </label>
...
// Register widget
function sport_recent_post_widget_register() {
    register_widget( 'sport_recent_post_widget' );
}

add_action( 'widgets_init', 'sport_recent_post_widget_register' );